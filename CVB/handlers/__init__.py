...
from .economy_handler      import router as wallet_router
...
from .ban                import router as gban_router
...
from .kick_handler       import router as gkick_router
...
for r in (
    ...
    captcha_router, dev_router, filters_router, flood_router, fun_router, gkick_router,
    moderation_router, modules_router, security_router, slowmode_router,
    warnings_router, balance_router, ban_router, misc_router, payment_router, stats_router,
    threads_router, unban_router, utilities_router,
):
